...
<div class="preview-container" style="display: ${(param.id != null and param.p != 'read') ? 'flex' : 'none' };">
        ...
        <div class="preview-top">
            ...
            <div class="preview-content">
                <div class="preview-options">
                    <a href="main?p=read&id=${requestScope.previewBook.id}" class="preview-start">Comenzar lectura</a>
